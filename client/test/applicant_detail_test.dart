...
void main() {
  ...
  testWidgets(
    'shows error state when fetching applicant detail fails and retry works',
    (tester) async {
      tester.view.physicalSize = const Size(390, 844);
      tester.view.devicePixelRatio = 1;
      addTearDown(tester.view.resetPhysicalSize);
  ...
  testWidgets('shows error snackbar when changing status to reviewing fails', (
    tester,
  ) async {
    tester.view.physicalSize = const Size(390, 844);
    tester.view.devicePixelRatio = 1;
  ...
  testWidgets('confirms Accept and transitions status to accepted', (
    tester,
  ) async {
    tester.view.physicalSize = const Size(390, 844);
    tester.view.devicePixelRatio = 1;
  ...
  testWidgets('confirms Reject and transitions status to rejected', (
    tester,
  ) async {
    tester.view.physicalSize = const Size(390, 844);
    tester.view.devicePixelRatio = 1;
    ...
    (tester) async {
      ...
      final applicant = Applicant(
        ...
        contactLinks: const [
          ...
          ContactLink(platform: 'line', value: '@meena_dev'),
        ],
      ...
      expect(
        find.text('นักศึกษาที่รักการเรียนรู้เทคโนโลยีใหม่ๆ'),
        findsOneWidget,
      );
      ...
      expect(
        find.text('https://github.com/example/internfinder'),
        findsOneWidget,
      );
...
class _FakeCompanyJobRepository implements CompanyJobRepository {
  _FakeCompanyJobRepository({this.applicant, this.error, this.updateError});
