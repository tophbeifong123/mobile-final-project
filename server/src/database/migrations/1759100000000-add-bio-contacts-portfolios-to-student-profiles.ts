  ...
  implements MigrationInterface
{
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "student_profiles" ADD COLUMN "bio" text NOT NULL DEFAULT ''`,
    );
    await queryRunner.query(
      `ALTER TABLE "student_profiles" ADD COLUMN "contact_links" jsonb NOT NULL DEFAULT '[]'::jsonb`,
    );
    await queryRunner.query(
      `ALTER TABLE "student_profiles" ADD COLUMN "portfolio_links" jsonb NOT NULL DEFAULT '[]'::jsonb`,
    );
  }
